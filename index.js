		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] Muriloo? Este é um recurso especial para o Muriloo ❌',
					ownerB: '[❗] Muriloo ? Este é um recurso especial para o Muriloo❌',
...
break
case 'glub':
tujuh = fs.readFileSync('./assets/glu.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
